...
# vmrghw/vmrglw FIXED 2026-06-04 (correct ZIP1.4S/ZIP2.4S; word-granular, no ev_mixed byte issue)
# — verified xpass + boot-clean, promoted from QUARANTINE to the scored gate.
T_av_vmrghw="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041088C 38600600 7C4119CE 80A10600"
TEST_ORDER+=(av_vmrghw)
T_av_vmrglw="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041098C 38600600 7C4119CE 80A10600"
TEST_ORDER+=(av_vmrglw)

# ==== QUARANTINE: confirmed JIT divergences awaiting a fix (ROADMAP A2) ========
# These run but do NOT count toward pass/fail/score — they are KNOWN-FAIL repros
# of the AltiVec ev_mixed element-order bug class (generated by gen-altivec-vectors.py
# BUG list). Only meaningful in JIT mode (interp-vs-JIT divergence). When the A2 fix
# lands they flip xfail→xpass and the harness flags it loudly: promote to TEST_ORDER.
# TODO: extend gen-altivec-vectors.py to also emit the merges (vmrgh*/vmrgl*) and
# pack (vpkuhum), which the changelog confirms are broken in the same class.
QUARANTINE_ORDER=()
# vmuloub: odd-byte multiply selects wrong element (ev_mixed); also emits MUL.8B not UMULL.8H
T_av_vmuloub="1005030C 1023030C 10400808 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmuloub)
# vmuleub: even-byte multiply diverges with distinct operands (interp 0x00000004, JIT 0x00040009)
T_av_vmuleub="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 10410A08 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmuleub)
# Merges + pack — same ev_mixed element-order class (gen-altivec-vectors.py BUG list).
T_av_vmrghb="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041080C 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmrghb)
T_av_vmrglb="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041090C 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmrglb)
T_av_vmrghh="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041084C 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmrghh)
T_av_vmrglh="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041094C 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vmrglh)
# (vmrghw/vmrglw promoted to TEST_ORDER 2026-06-04 — fixed + boot-verified)
T_av_vpkuhum="3C600001 60630203 90610600 3C600405 60630607 90610604 3C600809 60630A0B 90610608 3C600C0D 60630E0F 9061060C 38600600 7C2118CE 1041080E 38600600 7C4119CE 80A10600"
QUARANTINE_ORDER+=(av_vpkuhum)
