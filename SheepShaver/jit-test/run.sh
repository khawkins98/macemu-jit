...
T_vec_vadduwm="10050718 10230718 10400880 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vadduwm)

T_vec_vsubuwm="10050718 10230718 10400C80 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vsubuwm)

T_vec_vand="100F0718 10250718 10400C04 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vand)

T_vec_vor="100A0718 10250718 10400C84 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vor)

T_vec_vxor="100F0718 102F0718 10400CC4 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vxor)

T_vec_vnor="10000718 10200718 10400D04 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vnor)

T_vec_vmaxsw="10050718 103D0718 10400982 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vmaxsw)

T_vec_vminsw="10050718 103D0718 10400B82 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vminsw)

T_vec_vcmpequw="10050718 10250718 10400886 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vcmpequw)

T_vec_vcmpequw_ne="10050718 10230718 10400886 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vcmpequw_ne)

T_vec_vxor_self="10070718 100004C4 38600600 7C0119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vxor_self)

T_vec_lvx_stvx="100C0718 38600600 7C0119CE 10210CC4 7C2118CE 38600700 7C2119CE 80A10700 80C10704"
...
# ==== AltiVec coverage (Improvement Cycle 1, 2026-06-04) =======================
# Generated by the fp-altivec-vectors workflow, gated by make test-jit. Each:
# set up v0/v1 -> vector op into v2 -> stvx v2 to mem -> lwz result words into
# r5/r6 (REGDUMP only captures GPRs/CR/LR/CTR/XER, NOT FPRs/VRs).

# --- vmuloub v2,v0,v1 (multiply odd unsigned bytes, VX opcode 4) ---
T_vec_vmuloub="101F0718 103F0718 10400810 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vmuloub)

# --- vmuleub v2,v0,v1 (multiply even unsigned bytes) ---
T_vec_vmuleub="10030718 10250718 10400C10 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vmuleub)

# --- vmulosb v2,v0,v1 (multiply odd signed bytes) ---
T_vec_vmulosb="10020718 10230718 10400A10 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vmulosb)

# --- vmulouh v2,v0,v1 (multiply odd unsigned halfwords) ---
T_vec_vmulouh="101F0718 103F0718 10400890 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vmulouh)

# --- vpkpx v2,v0,v1 (pack pixels 32->16 bit) ---
T_vec_vpkpx="101F0718 103F0718 10400E1C 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vec_vpkpx)

# --- vsel v2,v0,v1,v3 (select by mask) ---
T_vsel_mask="1005030C 1023030C 1067030C 104008EA 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vsel_mask)

# --- vspltb v2,v1,0 / 8 / 15 (splat byte) ---
T_vspltb_byte0="1005030C 1023030C 10400C18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltb_byte0)
T_vspltb_byte8="1005030C 1023030C 10480C18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltb_byte8)
T_vspltb_byte15="1005030C 1023030C 104F0C18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltb_byte15)

# --- vsplth v2,v1,0 / 4 / 7 (splat halfword) ---
T_vsplth_hw0="1005030C 1023030C 10400C98 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vsplth_hw0)
T_vsplth_hw4="1005030C 1023030C 10440C98 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vsplth_hw4)
T_vsplth_hw7="1005030C 1023030C 10470C98 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vsplth_hw7)

# --- vspltw v2,v1,0 / 2 / 3 (splat word) ---
T_vspltw_word0="1005030C 1023030C 10400D18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltw_word0)
T_vspltw_word2="1005030C 1023030C 10420D18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltw_word2)
T_vspltw_word3="1005030C 1023030C 10430D18 38600600 7C4119CE 80A10600 80C10604"
TEST_ORDER+=(vspltw_word3)

# ==== FP arithmetic coverage (Improvement Cycle 1, 2026-06-04) ================
# CRITICAL CONSTRUCTION NOTE: the harness REGDUMP captures GPRs/CR/LR/CTR/XER but
# NOT FPRs (see sheepshaver_glue.cpp). The PRE-EXISTING fp_* vectors end at stfd
# and never load the result into a GPR -> they are VACUOUS (a wrong FP result is
# invisible, so JIT==interp trivially). These vectors fix that: each does
#   setup operands in FPRs (int bit pattern -> stw -> lfd/lfs)
#   -> the FP op into f1
#   -> stfd/stfs f1 to scratch memory
#   -> lwz the result word(s) back into r4 (/r5 for doubles)
# so the FP result lands in a GPR the REGDUMP captures and the JIT-vs-interpreter
# diff is meaningful. Stack layout under r1: A@0x100, B@0x110, C@0x120, result@0x130.
# Hex generated by jit-test/gen-fp-vectors.py (encoders verified).
...
# fmadd f1,f1,f3,f2: 2*4+3=11.0
T_fp_fmadd_real="3C604000 90610100 38600000 90610104 C8210100 3C604008 90610110 38600000 90610114 C8410110 3C604010 90610120 38600000 90610124 C8610120 FC2118BA D8210130 80810130 80A10134"
TEST_ORDER+=(fp_fmadd_real)
# fmsub f1,f1,f3,f2: 2*4-3=5.0
T_fp_fmsub_real="3C604000 90610100 38600000 90610104 C8210100 3C604008 90610110 38600000 90610114 C8410110 3C604010 90610120 38600000 90610124 C8610120 FC2118B8 D8210130 80810130 80A10134"
TEST_ORDER+=(fp_fmsub_real)
# fnmadd: -(2*4+3)=-11.0
T_fp_fnmadd_real="3C604000 90610100 38600000 90610104 C8210100 3C604008 90610110 38600000 90610114 C8410110 3C604010 90610120 38600000 90610124 C8610120 FC2118BE D8210130 80810130 80A10134"
TEST_ORDER+=(fp_fnmadd_real)
# fnmsub: -(2*4-3)=-5.0
T_fp_fnmsub_real="3C604000 90610100 38600000 90610104 C8210100 3C604008 90610110 38600000 90610114 C8410110 3C604010 90610120 38600000 90610124 C8610120 FC2118BC D8210130 80810130 80A10134"
...
# fmadds: 2*4+3=11.0f
T_fp_fmadds_real="3C604000 90610100 C0210100 3C604040 90610110 C0410110 3C604080 90610120 C0610120 EC2118BA D0210130 80810130"
