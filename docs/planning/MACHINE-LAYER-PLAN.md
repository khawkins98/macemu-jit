...
> **Status:** 🟢 Approved architecture (rev 4) — **spikes done; M0 + M1 complete (2026-06-10; M1 live acceptance PARTIAL — consumer-(b) blocked by pre-existing NK boot ceiling); next: M2**
> · **Created:** 2026-06-10
