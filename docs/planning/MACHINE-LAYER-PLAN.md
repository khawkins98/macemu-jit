...
> **Current state (header budget = 5 lines; the full arc lives in `CHANGELOG.md` and
> §"Archived status narratives" at the bottom of this doc):** milestones through **M7
> interrupt injection SHIPPED newworld default-ON**; **M8 slot-4 consumption CLOSED,
> shipped gated-off-green** (`SS_NW_IRQ_CONSUME`, 17th gate). **Active critical path: the
> VIA-IFR surface** (resolve a4@0x5000ee9a first). Re-scores: #3 CONFIRMED, #4 trigger
> recorded (§9). Live frontier: `docs/AGENT-CONTEXT.md` "Current frontier".
> · **Created:** 2026-06-10 · **Updated:** 2026-06-12 (header restructure: narrative relocated, nothing deleted)
