...
| S3 — two-supervisor reconciliation | blocked (user-decision: months-scale) | S3 deep Task-0; **item-0 = the Dolphin SHM-arena foundation feasibility spike** (NK-independent, pullable-forward); the live MMU co-lands here | S1-mechanism (DONE) + S2 |
